module.exports = function(context) {
    ...
    fs.readFile(context.opts.projectRoot + '/plugins/thirdlogin-plugin/src/android/ShareSDK/src/com/microduino/mdesigner/wxapi/WXEntryActivity.java', 'utf8', function(err, data) {
        if (err) throw err;
